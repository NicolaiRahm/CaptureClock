...
import tensorflow.alarm_clock.nicolai.com.roomup.roomDatabase.TimerRepository;
...
public class ViewModel_MainTimer extends AndroidViewModel {
    ...
    public ViewModel_MainTimer(@NonNull Application application) {
        ...
        soundLive.setValue(SoundUtil.getTitelForUri(getApplication(), newEditTimer.getSound()));
    ...
    public void setSound(String sound){
        ...
        soundLive.setValue(SoundUtil.getTitelForUri(getApplication(), sound));
    }
