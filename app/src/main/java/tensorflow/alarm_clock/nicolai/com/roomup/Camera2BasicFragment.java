...
public class Camera2BasicFragment extends androidx.fragment.app.Fragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    viewModel = ViewModelProviders.of(getActivity()).get(ViewModel_WakeUp.class);
  ...
  private String[] getRequiredPermissions() {
    try {
      String[] ps = {Manifest.permission.CAMERA};
  ...
  private void classifyFrame() {
    ...
    String[] result = classifier.classifyFrame(getContext(), bitmap, mObject);
    bitmap.recycle();
    ...
    if(result[1].equals("1")){
      ...
      showToast(getString(R.string.well_done));

      viewModel.setObjectCaptured(true);
    }
  }
